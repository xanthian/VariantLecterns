...
public class BetterArcheology {
    ...
    public static Map<Identifier, Block> BA_LECTERNS = Maps.newHashMap();

    public static Block BA_ROTTEN_LECTERN;

    public static void registerLecterns() {
        BA_ROTTEN_LECTERN = registerLectern("ba_rotten_lectern");
    }

    public static Block register(String name, Block block) {
        Identifier identifier = new Identifier(Initialise.MOD_ID, name);
        Registry.register(Registries.BLOCK, identifier, block);
        BA_LECTERNS.put(identifier, block);
