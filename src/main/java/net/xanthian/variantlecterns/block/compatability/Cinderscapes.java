...
public class Cinderscapes {
    public static Map<Identifier, Block> CS_LECTERNS = Maps.newHashMap();

    public static Block CS_SCORCHED_LECTERN;
    public static Block CS_UMBRAL_LECTERN;

    public static void registerLecterns() {
        CS_SCORCHED_LECTERN = registerLectern("cs_scorched_lectern");
        CS_UMBRAL_LECTERN = registerLectern("cs_umbral_lectern");
    }

    public static Block register(String name, Block block) {
        Identifier identifier = new Identifier(Initialise.MOD_ID, name);
        Registry.register(Registries.BLOCK, identifier, block);
        CS_LECTERNS.put(identifier, block);
